...
function AgentWorkspace({ importedGuides, publishedGuides, guidesLoading, guidesError, onSignOut }: { importedGuides: Guide[]; publishedGuides: Guide[]; guidesLoading: boolean; guidesError: string; onSignOut: () => void }) {
  ...
  return <main className="agent-app">
    ...
    <div className="agent-page">
      ...
      {view === "home" && area === "products" && <AllProductsHome catalog={productCatalog} guides={productGuides} onChooseCategory={chooseCategory} />}
      ...
      {view === "detail" && selectedGuide && <GuideDetail guide={selectedGuide} onBack={() => setView(area === "operational" ? "module" : "conditions")} />}
...
function AllProductsHome({ catalog, guides: catalogGuides, onChooseCategory }: { catalog: Product[]; guides: Guide[]; onChooseCategory: (productId: string, categoryId?: string) => void }) {
